...
- Make sure the generated code is formatted with JuliaFormatter. JuliaFormatter is installed as an app `jlfmt`. Use the `.JuliaFormatter.toml` config file.
...
- Keep the website docs up-to-date w.r.t. changes in functionality. When a new feature is big, consider adding new text in the Markdown docs.
